...
* [X] Add readme links to the github-pages deployed version of the app, and github repo links from the webapp back to the source. (Placeholders added)
* [X] Add readme and bottom-of-app links to https://www.svgrepo.com/svg/190518/trumpet (source of our trumpet icon) and to https://github.com/nbrosowsky/tonejs-instruments (Already present)
* [X] Add readme and license file - make this MIT license.
* [X] Create github actions to deploy to github pages for the repo, including minifying code. (Workflow exists)
